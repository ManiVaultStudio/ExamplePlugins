...
{
    getLearningCenterAction().setPluginTitle("");
    ...
    getPluginMetadata().setSummary("This example plugin shows how to implement a basic OpenGL-based view plugin in <b>ManiVault</b>.");
