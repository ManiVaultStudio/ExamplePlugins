> Repository: https://github.com/alangrafu/radar-chart-d3 <br>
> Author: Alvaro Graves <br>
> License: Apache-2.0 license, see [LICENSE_radar-chart](./LICENSE_radar-chart) file in this folder,

# Radar Chart
A reusable radar chart implementation in D3.js. Styleable, configurable and transition-capable.

[Radar Example](http://bl.ocks.org/tpreusse/2bc99d74a461b8c0acb1)
